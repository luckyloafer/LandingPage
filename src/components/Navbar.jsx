...
export const Navbar = () => {
  ...
  const settingLogo = async()=>{
    console.log("fiunck");
    const res = await axios.get("https://assessmentbackend.onrender.com/admin/updateNavLogo");
    console.log(res.data.navLogoURL);
    console.log(logo)
    setLogo(res.data.navLogoURL)
  }
          ...
          <div className='navbar-container-row'>
            <div className='navbar-container-row-logo'>
              <div className='navbar-container-row-logo-logobox'>
                ...
                <img src={logo} style={{width:84,height:84,borderRadius:50}}/>
              </div>
            </div>
